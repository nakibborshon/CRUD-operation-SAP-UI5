		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#combjitproject5borshonproject5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combjitproject5borshonproject5-display": {
								"semanticObject": "combjitproject5borshonproject5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bjit.project5.borshonproject5",
									"url": sap.ui.require.toUrl("com/bjit/project5/borshonproject5")
								}
							}
						}
					}
